...
var (
	...
	encodedKeyConfirmationWithEncryptedKey = []byte{
		0xa3, // map(3)
		0x01, // COSE_Key
		0xa5, 0x01, 0x02, 0x02, 0x42, 0x31, 0x31, 0x20, 0x01, 0x21, 0x58, 0x20,
		0xba, 0xc5, 0xb1, 0x1c, 0xad, 0x8f, 0x99, 0xf9, 0xc7, 0x2b, 0x05, 0xcf,
		...
		0xb7, 0x80, 0x4a, 0x3a, 0x64, 0xb6, 0xd7, 0x2c, 0xcf, 0xed, 0x6b, 0x6f,
		0xb6, 0xed, 0x28, 0xbb, 0xfc, 0x11, 0x7e,
		0x02, // Encrypted COSE_Key (COSE_Encrypt0)
		0xD8, 0x60, 0x84, 0x43, 0xA1, 0x01, 0x01, 0xA1, 0x05, 0x4C, 0x02, 0xD1,
		0xF7, 0xE6, 0xF2, 0x6C, 0x43, 0xD4, 0x86, 0x8D, 0x87, 0xCE, 0x58, 0x24,
		0x60, 0x97, 0x3A, 0x94, 0xBB, 0x28, 0x98, 0x00, 0x9E, 0xE5, 0x2E, 0xCF,
		0xD9, 0xAB, 0x1D, 0xD2, 0x58, 0x67, 0x37, 0x4B, 0x35, 0x81, 0xF2, 0xC8,
		0x00, 0x39, 0x82, 0x63, 0x50, 0xB9, 0x7A, 0xE2, 0x30, 0x0E, 0x42, 0xFC,
		0x81, 0x83, 0x40, 0xA2, 0x01, 0x25, 0x04, 0x4A, 0x6F, 0x75, 0x72, 0x2D,
		0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x40,
		0x05,       // KeyThumbprint
		0x58, 0x20, // bytes(32)
		0xb7, 0x1d, 0x9f, 0xc2, 0x7e, 0xe9, 0xce, 0x61, 0xa6, 0x05, 0x60, 0xb2,
		0xee, 0xee, 0xf7, 0xf6, 0x93, 0x4a, 0x6b, 0x9d, 0x57, 0xce, 0x12, 0x2b,
...
func TestKeyConfirmation_CBORUnmarshal_OK(t *testing.T) {
	...
	cnf = KeyConfirmation{}
	// the encoded data includes the EncryptedKey, but its ignored
	assert.Nil(t, dm.Unmarshal(encodedKeyConfirmationWithEncryptedKey, &cnf))
